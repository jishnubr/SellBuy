...
<head runat="server">
    ...
    <title>Buying and Selling Website</title>
    <!-- ============ Google fonts ============ -->
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-menubuilder">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/AdminLogin.aspx">Admin Login</asp:HyperLink>
                    </ul>
            </div>
        </div>
    </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="User Login" PostBackUrl="~/Seller and Buyer/UserLogin.aspx" />
                                  <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-warning" Text="User Registration" PostBackUrl="~/Seller and Buyer/User Registration.aspx" />                              
                            </div>
                        </div>
                    </fieldset>
                </div>
    ...
    <script type="text/javascript">
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="About Us" CausesValidation="False" PostBackUrl="~/About.aspx" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
